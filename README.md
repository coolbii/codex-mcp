...
| `create_app` | ✗ | **Only if `ENABLE_APP_SCAFFOLD=1`.** Scaffold React/Next apps either in a healthy existing Nx monorepo (`mode=existing`) or as a clean isolated Nx + Next workspace (`mode=isolated`). |
